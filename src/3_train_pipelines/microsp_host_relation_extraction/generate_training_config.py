# -----------------------------------------------------------------------------
#
# Create config file for updating only a single pipeline component, freezing
# the rest.
#
...
#
# Adapted from:
# https://github.com/explosion/projects/blob/v3/pipelines/ner_demo_replace/scripts/create_config.py
#
# -----------------------------------------------------------------------------
...
def main() -> None:
    ...
    output_path = Path(f"./config_{model_name}.cfg")

    create_config(model_name, 'ner', output_path)
